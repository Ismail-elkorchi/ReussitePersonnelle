 ...
 * @return void
 */
function focus_checkout_final_total() {
?>
...
add_action( 'edd_purchase_form_before_submit', 'focus_checkout_final_total', 999 );
 ...
 * @return void
 */
function focus_checkout_submit() {
?>
...
add_action( 'edd_purchase_form_after_cc_form', 'focus_checkout_submit', 9999 );
...
function credit_card_form() {
	...
	<fieldset id="edd_cc_fields" class="edd-do-validate">
		...
		<p id="edd-card-number-wrap">
			...
			<input type="text" autocomplete="on" pattern="[0-9]*" autocompletetype="cc-number" <?php if ( isset( $edd_options['stripe_js_fallback'] ) ) { echo 'name="card_number" '; } ?>id="card_number" class="card-number edd-input required" placeholder="<?php _e( 'Card number', 'easy-digital-downloads' ); ?>" />
		</p>
		<p id="edd-card-cvc-wrap">
			...
			<input type="text" size="4" autocomplete="off" pattern="[0-9]*" <?php if ( isset( $edd_options['stripe_js_fallback'] ) ) { echo 'name="card_cvc" '; } ?>id="card_cvc" class="card-cvc edd-input required" placeholder="<?php _e( 'Security code', 'easy-digital-downloads' ); ?>" />
		</p>
		<p id="edd-card-name-wrap">
			<label for="card_name" class="edd-label">
				<?php _e( 'Le nom du titulaire de la carte', 'easy-digital-downloads' ); ?>
				<span class="edd-required-indicator">*</span>
			</label>
			<input type="text" autocomplete="on" autocompletetype="cc-full-name" <?php if ( isset( $edd_options['stripe_js_fallback'] ) ) { echo 'name="card_name" '; } ?>id="card_name" class="card-name edd-input required" placeholder="<?php _e( 'Nom sur la carte', 'easy-digital-downloads' ); ?>" />
		</p>
		...
		<div id="ssl-seal">
			<img src="https://www.reussitepersonnelle.com/wp-content/themes/focus/images/button_truste.gif" width="143" height="45" />
			<br />
			<img src="https://www.reussitepersonnelle.com/wp-content/themes/focus/images/verisign.png" width="120" height="58" />
		</div>
