...
function reussitepersonnelle_social_sharing_buttons() {
	...
	$twitterURL = 'https://twitter.com/intent/tweet?text='.$pageTitle.'&amp;url='.$pageURL.'&amp;via=ReussitePerso';
	...
	?>
		<div class="social-sharing">
			<div class="twitter share-button">
				...
				<a rel="nofollow" target="_blank" data-name="twitter" class="share" href="<?php echo $twitterURL; ?>">Tweeter</a>
			</div>
			<div class="facebook share-button">
				...
				<a rel="nofollow" target="_blank" data-name="facebook" class="share" href="<?php echo $facebookURL; ?>">Partager</a>
			</div>
			<div class="googleplus share-button">
				...
				<a rel="nofollow" target="_blank" data-name="googleplus" class="share" href="<?php echo $googleURL; ?>">Partager</a>
			</div>
		</div>
	<?php
}
